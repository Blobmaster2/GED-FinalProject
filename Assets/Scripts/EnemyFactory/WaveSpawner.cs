...
{
    [SerializeField] private int spawnCount; // how many enemies to spawn according to the wave
    ...
    [SerializeField] private int spawnLevel; // level of enemies that are spawning
